...
function startGulp(name, opts) {
  ...
  var buildPath = './node_modules/bitcore-build-mec/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external bitcore-lib-mec -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:bitcore-lib-mec -o bitcore-lib-mec.js';
    }
